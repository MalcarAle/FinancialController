...
namespace Dima.Api.Handlers.CategoryHandler
{
    public class CategoryHandler(AppDbContext context) : ICategoryHandler
    {
        ...
        public async Task<Response<Category?>> DeleteAsync(DeleteCategoryRequest request)
        {
            ...
            {
                return new Response<Category?>(null, 500, "Erro ao deletar a categoria");
            }
        }
        ...
        public async Task<Response<Category?>> GetByIdAsync(GetCategoryByIdRequest request)
        {
            ...
            {
                return new Response<Category?>(null, 500, "Erro ao recuperar a categoria");
            }
        }
        ...
        public async Task<PagedResponse<List<Category>>> GetAllAsync(GetAllCategoriesRequest request)
        {
            ...
            {
                return new PagedResponse<List<Category>>(null, 500, "Erro ao recuperar as categorias");
            }
        }
    }
}